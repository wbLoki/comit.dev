...
| Platform | Link |
| --- | --- |
| Windows | [Download](https://api.comit.dev/actions/release?platform=win) |
| Mac | [Download](https://api.comit.dev/actions/release?platform=mac) |
| Linux | [Download](https://api.comit.dev/actions/release?platform=lin) |
